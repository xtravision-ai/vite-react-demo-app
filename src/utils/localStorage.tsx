...
export function saveToLocalStorageWithExpiration(key: string, data: any, expirationInMinutes = 60000, namespace = NAMESPACE){
    const now = new Date();
...
export function getFromLocalStorage(key:string, namespace = NAMESPACE) {
